    ...
    sectorText: function () {
      ...
      switch (this.description.sector) {
        ...
        case "Consumer Defensive" :
          text = "Сектор защиты потребителей включает компании, производящие продукты питания, напитки, товары для дома и личного пользования, упаковку или табак. Также включает компании, которые предоставляют услуги по обучению. "
          break;
        case "Utilities" :
